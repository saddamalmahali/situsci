<div class="container-fluid">
	<section class="card">
		<div class="card-block">
			<h5 class="with-border">Tambah Autentikasi</h5>
			<form action="<?= base_url()."index.php/auth_manager/tambah_auth" ?>" method="post">
		
				<div class="col-md-6">
					<fieldset class="form-group row">
						<label class="form-label semibold" for="name">Nama Auth</label>
						<input type="text" name="name" class="form-control" placeholder="Inputkan Nama Autentikasi">
					...
					<fieldset class="form-group row">
						...
						<textarea rows="6" name="deskripsi" class="form-control" placeholder="Deskripsi"></textarea>
						<small class="text-muted"><?= form_error('name') ?></small>
					</fieldset>
